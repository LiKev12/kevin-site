    ...
    return (
      <div className="projects-grid">
        ...
        <Card shadow={5} className='Card'>
          ...
          <CardActions border>
            <Button colored>
              <a href="https://github.com/LiKev12/Solve24" target="_blank" rel="noopener noreferrer" className="normalLink">GitHub</a>
            </Button>
            <Button colored>
              <a href="https://solve-game-24.herokuapp.com/" target="_blank" rel="noopener noreferrer" className="normalLink">Live Demo</a>
            </Button>
          </CardActions>
